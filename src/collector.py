"""
collector.py — Monitor de preços Peruíbe via Google Hotels.
Usa caminho relativo ao diretório do projeto (não ao módulo).
"""
...
def push_github():
    ...
    script = Path(__file__).parent.parent / "scripts" / "push_github.ps1"
